<div class="row groupe__titre mt-3">
    <div class="col-12 text-center">
        Woods Lake
    </div>
</div>
<div class="row groupe__card justify-content-center text-start my-3">
    <div class="col-8">
        <div class="groupe__card--titre">
            <div id="extrait">Vanessa</div>
            <div class="bande"></div>
        </div>
    </div>
</div>
...
<div class="row groupe__card justify-content-center text-end my-3">
    <div class="col-8">
        <div class="groupe__card--titre">
            <div id="extrait">Jérôme</div>
            <div class="bande"></div>
        </div>
    </div>
</div>
