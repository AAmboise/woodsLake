...
$(document).ready(function(){
	...
	**********/
	...
	$('.panel__nav--users').on('click', function(){
        ...
        $('.panel__card--concerts, .panel__card--extraits, .panel__card--photos, .panel__card--galleries').hide()
    ...
    $('.panel__nav--concerts').on('click', function(){
        ...
        $('.panel__card--users, .panel__card--extraits, .panel__card--photos, .panel__card--galleries').hide()
    ...
    $('.panel__nav--extraits').on('click', function(){
        ...
        $('.panel__card--users, .panel__card--concerts, .panel__card--photos, .panel__card--galleries').hide()
    })
    $('.panel__nav--photos').on('click', function(){
        $('.panel__nav--photos').addClass('bg-light')
        $('.panel__card--photos, .panel__card--galleries').show()
